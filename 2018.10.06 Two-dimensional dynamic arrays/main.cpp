...
enum ArrayEnum { COLUMNS = 5, LINES = 5 };

template<typename T> void FillArray(T[], const int, const int); // fill two-dimensional array
template<typename T> void OutPutArray(T[], const int, const int); // output two-dimensional array
template<typename T> void SortArray(T[], const int, const int); // Growth sorting by a bubble method of two-dimensional array
template<typename T> void LinesOffset(T[], int, int); // lines offset
template<typename T> void ColumnsOffset(T[], int, int); // columns offset
