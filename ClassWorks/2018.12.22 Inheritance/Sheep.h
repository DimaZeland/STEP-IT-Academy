...
protected:
    ...
    double speed = 10;
public:
    Vehicle(std::string name = "Sea LTD", double d = 10) : vendor(name), speed(d) {
        std::cout << "\n Vehicle Ctor called!\n";
    }
...
public:
    ...
    Sheep(unsigned int turb, std::string Vendor = "Sea LTD", double Speed = 10, std::string Name = "Noname",
