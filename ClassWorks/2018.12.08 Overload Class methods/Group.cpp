...
Group::Group(Person leader, Person *def_group, size_t def_size, std::string name) : Leader(leader), group(def_group),
                                                                                    size(def_size), its_my_name(name) {}
